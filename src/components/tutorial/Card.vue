...
&#60;/template&#62;
      ...
      <p class="q-py-lg"></p>
      <p>10개의 멤버 카드가 순식간에 만들어졌습니다. 급하게 만들다 보니 간격을 주는 걸 깜박했네요.
...
&#60;/template&#62;
      ...
      <p class="q-py-lg"></p>
      <p>어떤가요? 래핑 된 <em>QCard</em> 컴포넌트가 우리가 원하던 간격으로 표시되고 있다는 것을 확인할 수 있습니다. <code>col-6 col-md-4</code> 클래스를 사용하여 화면의
        너비가 중형 사이즈(md:1024px) 이상인 경우 4/12 = 33%이므로, 한 라인에 <em>QCard</em> 컴포넌트가 3개씩 배치되고 중형 사이즈 미만인 경우는 6/12 = 50%로 한
        라인에
        2개씩 배치됩니다. </p>
