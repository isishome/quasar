...
<template>
  <div class="q-px-md text-body2">
    ...
    <section id="container" data-name="컨테이너(부모) 관리">
      <Title sub>컨테이너(부모) 관리</Title>
      <section id="direction" data-name="방향 설정">
        ...
        <q-tab-panels v-model="practice1">
          <q-tab-panel name="row">
            <Code language="html">
        <textarea readonly>
&#60;div class="row"&#62;
...
&#60;/div&#62;
          ...
          <q-tab-panel name="column-reverse">
            <Code language="html">
        <textarea readonly>
...
&#60;/div&#62;
      ...
      <section id="wrap" data-name="기본 줄 바꿈">
        ...
        <p><strong>주축에 수직으로 정렬하려면</strong> 아래 클래스를 사용하세요. 이것은 현재 줄의 교차 축을 따라 아이템(자식 요소)이 배치되는 방식에 대한 기본 동작을 정의합니다. 교차되는
          축에
