...
<template>
  <div class="text-center text-body1">
    ...
    <p class="q-mt-lg">
      예전 회사에서 새로운 프레임워크로 프로젝트를 진행할 기회가 생겼는데 그때 시작한 게 <strong class="text-green-7">vue.js</strong>였습니다.<br />
      <strong>visual studio</strong>로 <strong>asp.net</strong>과 <strong>jquery</strong>만 줄 곳 사용하다 보니 새 작업 환경을 구축하는 게 여간
      어려운 일이 아니었죠. 거기에 좀 더 나은 UI(사용자 인터페이스)를 제공하고자 프레임워크를 찾아다니다
      <strong class="text-primary">quasar&nbsp;framework</strong>를 처음 만나게 되었습니다.
    </p>
    <p class="text-h6 text-weight-bold">
      그런데 이것이 제 개발 인생에 엄청난 변화를 가져왔습니다.
    </p>
    <p>
      시각적인 요소를 전부 디자이너에게 의존하던 것에서 벗어나<br />
      <u>보기 좋은 레이아웃을 구현해 주며</u>,<br />
      <u>사용성도 좋고</u>,<br />
      <u>반응형 웹을 제작할 때 들어가는 큰 수고스러움도 줄여주며</u>,<br />
      <u>무엇보다도 개발에 소요되는 시간을 크게 절약</u>할 수 있게 되었죠.
    </p>
    <p>
