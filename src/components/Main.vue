...
<template>
  <div class="text-center text-body1 q-px-md">
    ...
    <p class="q-mt-lg">
      이전 회사에서 새로운 프레임워크로 프로젝트를 진행할 기회가 생겼는데 그때 시작한 게 <strong class="text-green-7">vue.js</strong>였습니다.<br />
      visual studio로 asp.net과 jquery만 줄 곳 사용하다 보니 새 작업 환경을 구축하는 게 여간
      어려운 일이 아니었죠. 거기에 좀 더 나은 UI(사용자 인터페이스)를 만들어보고 싶어 많은 UI 관련 프레임워크를 찾아보게 되었습니다.
      그리고 <strong class="text-primary">quasar&nbsp;framework</strong>를 처음 만나게 되었습니다.
    </p>
    <p class="text-h6 text-weight-bold">
      그런데 이것이 제 개발 습관에 엄청난 변화를 가져왔습니다.
    </p>
    <p>
      ...
      <u>무엇보다도 개발에 소요되는 시간을 크게 절약할 수 있게 되었죠.</u>
    </p>
    <p>
